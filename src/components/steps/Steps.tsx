...
function StepsComponent({stepsData,currentStep,handleStep}:{stepsData:any,currentStep:number,handleStep:any}) {
	return (
		<nav aria-label="Progress">
			<ol className="space-y-4 md:flex md:space-y-0 md:space-x-8">
            {stepsData.map((step:{id:string,step:number,name:string}) => (
